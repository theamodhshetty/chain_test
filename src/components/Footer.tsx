        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600 max-w-xs">
              ChainInsight merges Web3 with AI to revolutionize crypto investing through our multi-agent system.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/assets" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  Crypto Assets
                </Link>
              </li>
              <li>
