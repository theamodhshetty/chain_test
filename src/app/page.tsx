    ...
    <main className="flex min-h-screen flex-col">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div key={index} className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div 
                key={index} 
                className="bg-white p-6 rounded-xl border hover:shadow-md transition-all"
                style={{
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-10 w-10 rounded-full flex items-center justify-center text-white text-2xl font-bold"
                    style={{
                ...
                <button 
                  className="w-full py-2 text-sm border rounded-md hover:bg-opacity-10 flex items-center justify-center gap-1"
                  style={{
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button 
            className="px-8 py-4 bg-white text-blue-900 hover:bg-blue-50 rounded-lg font-medium inline-flex items-center justify-center transition-all gap-2"
            onClick={handleGetStarted}
          >
            Get Started Now
          </button>
