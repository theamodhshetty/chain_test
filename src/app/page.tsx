...
import { ArrowRight, BarChart3, Brain, ChevronRight, LucideIcon, Shield, TrendingUp, Zap, AlertTriangle } from 'lucide-react';
...
function FeatureCard({ title, description, icon: Icon }: FeatureProps) {
  return (
    <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all group">
      <div className="w-12 h-12 bg-blue-100 rounded-lg text-blue-800 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
...
function AgentCard({ name, specialty, description, avatarUrl }: AgentProps) {
  return (
    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:border-blue-200 transition-colors cursor-pointer relative group">
      <div className="flex items-center mb-4">
        <div className="relative w-12 h-12 rounded-full overflow-hidden mr-4 bg-gradient-to-br from-blue-400 to-purple-500">
      ...
      <div className="absolute inset-0 bg-white/80 backdrop-blur-sm items-center justify-center flex opacity-0 group-hover:opacity-100 transition-opacity rounded-xl">
        <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Demo Agent - Not Functional</span>
      </div>
    </div>
  );
}

// Define a LineChart component for the dashboard preview
function LineChart({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M0,50 L5,45 L10,48 L15,40 L20,42 L25,35 L30,38 L35,30 L40,32 L45,25 L50,28 L55,20 L60,22 L65,15 L70,18 L75,10 L80,12 L85,5 L90,8 L95,0 L100,3"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      />
...
const features = [
  {
    ...
    description: 'Ten specialized AI agents with different investment philosophies collaborate to provide balanced insights.',
    icon: Brain
  },
  {
    title: 'On-Chain Data Analysis',
    description: 'Real-time analysis of blockchain transactions and trends to identify emerging opportunities.',
    icon: BarChart3
  },
  {
    title: 'Risk Management',
    description: 'Personalized risk assessment and portfolio optimization to protect and grow your investments.',
    icon: Shield
  },
  {
    title: 'Market Sentiment',
    description: 'AI-powered social media and news sentiment tracking to gauge market emotions.',
    icon: TrendingUp
  },
  {
    title: 'Intrinsic Value Calculation',
    description: 'Fundamental valuation of crypto assets based on utility, adoption, and growth potential.',
    icon: BarChart3
  },
  {
    title: 'Clear Recommendations',
    description: 'Simple, actionable investment recommendations that eliminate decision paralysis.',
    icon: ArrowRight
  }
];
...
const agents = [
  {
    ...
    description: 'Focuses on finding undervalued cryptocurrencies with strong fundamentals and utility.',
    avatarUrl: '/avatars/warren.png'
  },
  {
    name: 'Catherine AI',
    specialty: 'Innovation Analysis',
    description: 'Specializes in identifying disruptive blockchain technologies with exponential growth potential.',
    avatarUrl: '/avatars/catherine.png'
  },
  {
    name: 'Ray AI',
    specialty: 'Macro Trends',
    description: 'Analyzes global economic trends and their impact on the cryptocurrency market.',
    avatarUrl: '/avatars/ray.png'
  },
  {
    name: 'Peter AI',
    specialty: 'Early Adoption',
    description: 'Focuses on finding promising early-stage projects with strong founding teams.',
    avatarUrl: '/avatars/peter.png'
  },
  {
    name: 'Michael AI',
    specialty: 'Contrarian Analysis',
    description: 'Takes positions counter to prevailing market sentiment when data suggests opportunity.',
    avatarUrl: '/avatars/michael.png'
  },
  {
    name: 'Benjamin AI',
    specialty: 'Technical Analysis',
    description: 'Analyzes price patterns and market structures to identify optimal entry and exit points.',
    avatarUrl: '/avatars/benjamin.png'
  }
];
